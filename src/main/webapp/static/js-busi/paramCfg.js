...
function editView(id) {
	...
	window.location.href = basePath + '/paramCfg/toedit?menuIndex='+menuIndex+'&id=' + id;
}

function addView(){
	window.location.href = basePath + '/paramCfg/toadd?menuIndex='+menuIndex;
}
...
UnParamCfg.prototype = {
	...
	getQueryParams : function(params) {
		...
		params.apn = unParamCfgParams["apn"];
		params.m2m = unParamCfgParams["m2m"];
		params.threshold = unParamCfgParams["threshold"];
		params.flowSize = unParamCfgParams["flowSize"];
		return params;
	},
	bindDataToTable : function() {
		...
		$('#reportTable')
				.bootstrapTable(
						{
							method : 'post',
							url : basePath + '/paramCfg/queryCfg',
